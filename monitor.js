...
var connectionString = 'HostName=MeuHubNet14.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=xXm/DyvixozBXtlTsSsaTfE+xfMtCR1P8KWzeBGmAlA=';
...
var printMessage = function (message) {
  if ("MeuDeviceRic" === message.annotations["iothub-connection-device-id"]) {
